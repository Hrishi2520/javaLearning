...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/home/angrybird/workspace/personal/javaLearning/TestDB/"+DB_NAME;
    ...
    public void close() {
        try {
            ...
            System.out.println("Couldn't connect connection: "+ e.getMessage());
        }
    }
    ...
    public List<String> queryAlbumForArtists(String artistName, int sortOrder) {
        //SELECT albums.name FROM albums INNER JOIN artists ON albums.artist = artists._id WHERE artists.name = artistName
